...
public class ConnectConstants {
    ...
    public static final int BROADCAST_JOIN = 0;
    public static final int BROADCAST_EXIT = 1;

    public static final int UDP_JOIN = 0;

    public static final int GAME_CONNECTED = 11;
